...
interface Props {
    selectedNode: any;
    onChange: (nodeId: string, newKind: any) => void;
...
export default function PropertiesPanel({ selectedNode, onChange, onDelete }: Props) {
    ...
    const handleGenericChange = (key: string, val: any) => {
...
// ==========================================
// Specialized Input Editor with Dataset DB
// ==========================================
...
function InputProperties({ nodeId, config, onConfigChange, onDelete }: InputProps) {
